...
public class ControllerCAAlertDashboard implements Initializable {
...
//            imageView.setFitWidth(35);
    ...
    public void passVariables(PcapNetworkInterface nif, ScheduledThreadPoolExecutorHandler handler, NetworkCapture capture, boolean ARPDetection, Integer threshold, AWSSMS USMSHandler, String absolutePath, OutlookEmail OEmailHandler) {
        this.device = nif;
    ...
    public void returnToCaptureScreen(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("CAAlerts.fxml"));
