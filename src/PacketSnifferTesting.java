...
public class PacketSnifferTesting {
    ...
    private static final String COUNT_KEY
            = PacketSnifferTesting.class.getName() + ".count";
    private static final int COUNT
            = Integer.getInteger(COUNT_KEY, -1); // -1 -> loop infinite

    private static final String READ_TIMEOUT_KEY
            = PacketSnifferTesting.class.getName() + ".readTimeout";
    private static final int READ_TIMEOUT
            = Integer.getInteger(READ_TIMEOUT_KEY, 100); // [ms]

    private static final String SNAPLEN_KEY
            = PacketSnifferTesting.class.getName() + ".snaplen";
    ...
    private PacketSnifferTesting(PcapNetworkInterface nif) {
        this.nif = nif;
    }
    ...
    public static void main(String[] args) throws PcapNativeException, NotOpenException {
        ...
        PacketSnifferTesting packetSnifferTesting = new PacketSnifferTesting(nif);
        if (args.length>0){
            int time= Integer.parseInt(args[0]);
            packetSnifferTesting.setTime(time);
        }

        packetSnifferTesting.startSniffing();
    }
